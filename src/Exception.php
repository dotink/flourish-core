<?php namespace Dotink\Flourish {
	...
	abstract class Exception extends \Exception
	{
		...
		public function __construct($message='')
		{
			...
			$args = array_map(array(__NAMESPACE__ . '\Exception', 'dump'), $args);

			parent::__construct((string) Core::compose($message, $args));
			$this->code = $code;
		 ...
		 * @param  string ...
		 * @return Exception  The exception object, to allow for method chaining
		 */
